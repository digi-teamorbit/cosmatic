...
{	
	...
	public function categoryDetail($id) {
		...
		return view('shop.category_detail',['category'=>$category],['innerbanner'=>$innerbanner]);
    ...
    public function shop()
    {
        ...
        return view('shop.category', ['shop'=> $shop],['innerbanner'=>$innerbanner]);
    }
    ...
    public function Detail($id)
    {
        ...
        return view('shop.detail', ['product_detail'=> $product_detail,]);
    }
